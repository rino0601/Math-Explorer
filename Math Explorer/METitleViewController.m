...
-(void)viewDidLayoutSubviews {
	...
	[titleLabel setText:[NSString stringWithUTF8String:(const char *)sqlite3_column_text(localizer, 0)]];
	sqlite3_reset(localizer);
	
	sqlite3_bind_text(localizer, 1, [@"me.subtitle" UTF8String], -1, NULL);
	sqlite3_step(localizer);
	[subtitleLabel setText:[NSString stringWithUTF8String:(const char *)sqlite3_column_text(localizer, 0)]];
